...
{/* ════════════════════════════════
     SECTION 1 — FIXED NAV
════════════════════════════════ */}
<nav className="nav" id="mainNav" aria-label="Main navigation">
    <div className="nav-inner">

        <a href="index.html" className="nav-back" aria-label="Back to home">
        ...
        <a href="index.html" className="nav-logo" aria-label="ASMI Career">
            <img src="asmi-logo.png" alt="ASMI Career"/ />
        </a>

        <ul className="nav-links" role="list">
            <li><a href="/tools/college-predictor/">Colleges</a></li>
            <li><a href="inquiry.html">Counselling</a></li>
            <li><a href="#packages">Packages</a></li>
            <li><a href="#tools">Services</a></li>
            <li><a href="/tools/events.html">News & Events</a></li>
            <li><a href="#about-us">About Us</a></li>
            <li><a href="inquiry.html">Contact Us</a></li>
        </ul>

        <div className="nav-cta">
            <a href="inquiry.html" aria-label="Book a free counselling session">
                Book Free Session
        ...
        <button className="nav-hamburger" id="hamburger" aria-label="Open menu" aria-expanded="false" aria-controls="navDrawer">
            <span></span>
            <span></span>
            <span></span>
        </button>
...
<div className="nav-drawer" id="navDrawer" role="navigation" aria-label="Mobile navigation">
    <a href="index.html">← Home</a>
    <a href="/tools/college-predictor/">Colleges</a>
    <a href="inquiry.html">Counselling</a>
    <a href="#packages">Packages</a>
    <a href="#tools">Services</a>
    <a href="/tools/events.html">News & Events</a>
    <a href="#about-us">About Us</a>
    <a href="inquiry.html">Contact Us</a>
    <a href="inquiry.html" className="drawer-cta">Book Free Session →</a>
</div>
    ...
    <div className="hero-inner">
        ...
        <div className="hero-left">
            ...
            <div className="hero-ctas">
                <a href="inquiry.html" className="btn-primary">Book Free Counselling →</a>
    ...
    <div className="unis-inner">
        ...
        <div className="unis-header">
            ...
            <div className="unis-header-right">
                ...
                <button className="unis-arrow-btn" id="uniPrev" aria-label="Previous universities">‹</button>
                <button className="unis-arrow-btn" id="uniNext" aria-label="Next universities">›</button>
            </div>
        </div>

        <div className="unis-track" id="uniTrack" role="list">
        ...
        <div className="why-right" role="img" aria-label="Why ASMI counselling platform">
            <div className="why-overlay-card">
                ...
                <div className="why-overlay-btns">
                    <a href="inquiry.html" className="why-btn-dark">Book a Free Call 📞</a>
    ...
    <div className="pricing-inner">
        ...
        <div className="pricing-banner">
            ...
            <div className="pricing-banner-btns">
                <a href="inquiry.html" className="banner-btn-white">Book My Free Session →</a>
...
<section style={{ background: '#1a0040', padding: '56px 80px' }} aria-labelledby="outcomes-heading">
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: '32px' }}>
            <a href="inquiry.html" style={{ display: 'inline-block', background: '#FFD700', color: '#1a0040', fontFamily: '\'Montserrat\',sans-serif', fontWeight: '800', fontSize: '14px', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none' }}>Join Them — Book Free Counselling →</a>
        </div>
    </div>
</section>
    ...
    <div className="tools-inner">
        ...
        <div className="tools-grid">
            ...
            <div className="tool-card">
                ...
                <a href="inquiry.html" className="tool-cta paid-cta">Get Access →</a>
            </div>
    ...
    <div className="packages-inner">
        ...
        <div className="packages-grid">
            ...
            <div className="pkg-card" data-pkg-animate>
                ...
                <a href="inquiry.html" className="pkg-cta">Learn More →</a>
            </div>
...
<section className="cta-banner" aria-labelledby="cta-heading">
    ...
    <div className="cta-inner">
        ...
        <div className="cta-buttons animate">
            <a href="inquiry.html" className="cta-btn-primary">Book My Free Session →</a>
