    ...
    <div className="about-page">
      ...
      <section className="about-hero">
        <div className="about-hero-inner">
          <span className="about-eyebrow">ABOUT ASMI ENGINEERING</span>
          <h1 className="about-headline">
            We've Lived This Journey.<br />That's Why We Do This.
          </h1>
          <p className="about-sub">
            Founded in 2014 by someone who faced the chaos of admissions personally —
            ...
            <div className="about-founder-card">
              ...
              <div className="about-founder-info">
                ...
                <p className="about-founder-bio">
                  Having faced the complexity of admissions firsthand, Anish founded ASMI Career
                  ...
                  25,000 students to their dream seats across India.
                </p>
              </div>
            </div>
        ...
        <div className="about-vm-inner">
          <div className="about-vm-card">
            ...
            <p className="about-vm-text">
              To empower every aspiring engineer with transparent and accurate guidance —
              offering the knowledge and support needed to navigate the admission process
              confidently and begin their engineering career on a strong foundation.
            </p>
          </div>
          <div className="about-vm-card">
            <div className="about-vm-icon">🚀</div>
            ...
            <p className="about-vm-text">
              To simplify engineering admissions with step-by-step guidance and personalised,
        ...
        <div className="about-story-inner">
          ...
          <div className="about-story-grid">
            <div className="about-story-text">
              <p>
                Every year, thousands of students lose their admission seat — not because their
              ...
              <p>
                ...
                agents were charging exorbitant fees for "guaranteed" seats that didn't exist,
              ...
              <p>
                ...
                ASMI is the most trusted name in counselling in the state.
              </p>
            </div>
      ...
      <section className="about-branches">
        <div className="about-branches-inner">
          ...
          <Link href="/engineering/contact" className="about-branches-link">
      ...
      <section className="about-cta">
        <div className="about-cta-inner">
          ...
          <div className="about-cta-btns">
            <Link href="/engineering/inquiry" className="about-cta-btn-primary">
